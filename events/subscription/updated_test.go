...
func subscriptionUpdatedData() struct {
	...
	d := test.Sign(map[string]string{
		...
		"old_next_bill_date":       "2019-05-13",
		"old_price":                "99.98",
		"old_quantity":             "1",
		"old_unit_price":           "49.99",
		"old_status":               "pending",
		"old_subscription_plan_id": "10",
	...
	su := Updated{
		...
		OldNextBillDate:       &types.TimeYYYYMMDD{test.ParseTime(types.TimeFormatYYYYMMDD, d.M["old_next_bill_date"])},
