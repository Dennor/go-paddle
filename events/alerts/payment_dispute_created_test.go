...
func subscriptionPaymentDisputeCreatedData() struct {
	d   test.Data
...
func TestPaymentDisputeCreated(t *testing.T) {
	data := subscriptionPaymentDisputeCreatedData()
	t.Run("UnmarshalJSON", func(t *testing.T) {
		assert := assert.New(t)
		var actual PaymentDisputeCreated
	...
	t.Run("ImplementsEvent", func(t *testing.T) {
		assert := assert.New(t)
		assert.Implements((*events.Event)(nil), &PaymentDisputeCreated{})
	})
}

func BenchmarkPaymentDisputeCreated(b *testing.B) {
	data := subscriptionPaymentDisputeCreatedData()
	var pdc PaymentDisputeCreated
